...
module CPU_BRANCH_EQUAL_TB;
    ...
    initial begin
        ...
        $display("");
        $display("========================================");
        $display("CPU EQUALITY BRANCH TEST");
        $display("========================================");
        ...
        /*
         * Test 1:
         * Confirm that the CPU reached halt.
         */
        tests_run = tests_run + 1;
        ...
        /*
         * R1 contains the equality-comparison value.
         */
        check_register(
            3'd1,
            8'h05,
        ...
        /*
         * R2 confirms execution continued at the taken target.
         */
        check_register(
            3'd2,
            8'h11,
        ...
        /*
         * R3 confirms the not-taken fall-through path executed.
         */
        check_register(
            3'd3,
            8'h22,
        ...
        /*
         * R4 must remain zero because its copy instruction was
        ...
        /*
         * The final accumulator value comes from the not-taken path.
         */
        check_acc(
            8'h22,
            6
        ...
        /*
         * Halt is stored at address 0x000C.
         */
        check_pc(
            16'h000C,
            7
        ...
        /*
         * The program executes ten non-halt instructions:
         *
         * 0, 1, 2, 3, 6, 7, 8, 9, 10, and 11.
         */
        tests_run = tests_run + 1;
        ...
        /*
         * Verify that halt freezes the final state.
         */
        repeat (3) begin
            @(posedge clk);
            #1;
