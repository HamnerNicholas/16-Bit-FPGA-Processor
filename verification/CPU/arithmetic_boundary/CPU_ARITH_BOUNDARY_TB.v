...
module CPU_ARITH_BOUNDARY_TB;
    ...
    initial begin
        ...
        $display("");
        $display("========================================");
        $display("CPU ARITHMETIC BOUNDARY TEST");
        $display("========================================");
        ...
        /*
         * Test 2:
         * Maximum unsigned 8-bit value was generated correctly.
         */
        check_register(
            3'd1,
            8'hFF,
         ...
         * Test 5:
         * 0xFF * 2 = 0x01FE.
         * Only the lower eight bits are retained.
         */
        check_register(
            3'd4,
            8'hFE,
        ...
        /*
         * Test 6:
         * Confirm the division numerator was stored correctly.
         */
        check_register(
            3'd5,
            8'h0A,
        ...
        /*
         * Test 7:
         * Integer division truncates 10 / 3 to 3.
         */
        check_register(
            3'd6,
            8'h03,
        ...
        /*
         * Test 8:
         * Zero divided by a nonzero value produces zero.
         */
        check_register(
            3'd7,
            8'h00,
        ...
        /*
         * Test 9:
         * Final accumulator contains the final division result.
         */
        check_acc(
            8'h00,
            9
        ...
        /*
         * Test 10:
         * Halt is located at instruction address 0x000E.
         */
        check_pc(
            16'h000E,
            10
        ...
        /*
         * Verify that halt freezes architectural state.
         */
        repeat (3) begin
            @(posedge clk);
            #1;
        ...
        $display("R7:  0x%0h", dut.register_file_inst.registers[7]);
        $display("HALT: %b", halt);
        $display("========================================");
